...
Understanding these tests is important for:
1. Users who want to understand how to properly use the API
2. Future refactoring if we decide to make Graph immutable
"""
