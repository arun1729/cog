...
def run_scenario(name, pairs, iters):
    ...
    if HAS_MSGPACK:
        ...
        print(f"avg payload: spindle_pack={sp_avg:.1f}B  (msgpack not installed, skipping comparison)")
    ...
    if HAS_MSGPACK:
        ...
        print(f"packb    spindle_pack: {sp_n/sp_t:>12,.0f} ops/s")
    ...
    if HAS_MSGPACK:
        ...
        print(f"unpackb  spindle_pack: {sp_n/sp_t:>12,.0f} ops/s")
    ...
    if HAS_MSGPACK:
        ...
        print(f"rt       spindle_pack: {n/sp_t:>12,.0f} ops/s")
