...
def detect_codec(fh, file_size):
    ...
    raise ValueError(
        "unrecognized store format (legacy v0/v1 is no longer supported, please use the migration utility to port data to the new format); "
