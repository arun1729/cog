...
╚██████╗╚██████╔╝╚██████╔╝██████╔╝██████╔╝
 ╚═════╝ ╚═════╝  ╚═════╝ ╚═════╝ ╚═════╝ 
        ...
        <div class="status-line">
            ...
            <span style="color: #666;">v{COGDB_VERSION}</span>
        </div>
        
        <div class="info-block">
            <div class="section-title">Server</div>
            <div class="info-row"><span class="info-label">Address:</span><span class="info-value">{self._get_local_ip()}:{self.server.server_address[1]}</span></div>
            <div class="info-row"><span class="info-label">Connect URL:</span><span class="info-value">http://{self._get_local_ip()}:{self.server.server_address[1]}/&lt;graph&gt;</span></div>
        </div>
...
╚██████╗╚██████╔╝╚██████╔╝██████╔╝██████╔╝
 ╚═════╝ ╚═════╝  ╚═════╝ ╚═════╝ ╚═════╝ 
        ...
        <div class="info-block">
            ...
            <div class="info-row"><span class="info-label">Connect URL:</span><span class="info-value">http://{self._get_local_ip()}:{self.server.server_address[1]}/{graph_name}</span></div>
